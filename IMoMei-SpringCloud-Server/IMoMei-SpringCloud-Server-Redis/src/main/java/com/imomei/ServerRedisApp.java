...
public class ServerRedisApp {
    public static void main(String[] args) {
        SpringApplication.run(ServerRedisApp.class, args);
    }

    @Bean
    public RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory factory) {       // 手动重写RedisTemplate
